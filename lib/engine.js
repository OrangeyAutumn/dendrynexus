...
(function() {
  ...
  UserInterface.prototype.displayPinnedCards2 = function(cards) {};
  ...
  if (choiceScene.pinnedCardType === "advisor") {
    pinnedCards.push(c);
  } else if (choiceScene.pinnedCardType === "faction") {
    pinnedCards2.push(c);
  }
}
      }
      ...
      this.ui.displayPinnedCards(pinnedCards2);
    } else {
